                        ...
                        <div className="uk-grid-margin uk-grid uk-grid-stack" data-uk-grid>
                            <div className="uk-width-1-1@m">
                                <div className="uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large">
                                    ...
                                    <h3 className="uk-card-title uk-text-center">Login with your Account</h3>
                                    <form>
                                        ...
                                        <div className="uk-margin">
                                            <a className="uk-button uk-button-primary uk-button-large uk-width-1-1" style={{ background: "#6c63ff" }} onClick={login}>Login</a>
                                        </div>
                                        <div className="uk-text-small uk-text-center">
                                            Not registerd? <a href="/signup" style={{ color: "#6c63ff" }}>Create Account</a>
                                        </div>
                                        <div className="uk-text-small uk-text-center">
                                            Forgot Password? <a href="/password-reset-email" style={{ color: "#6c63ff" }}>Reset Password</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
