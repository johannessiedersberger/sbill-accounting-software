                            ...
                            <div className="uk-width-1-1@m">
                                <div className="uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large">
                                    ...
                                    <form>
                                        ...
                                        <div className="uk-margin">
                                            <a className="uk-button uk-button-primary uk-button-large uk-width-1-1" style={{ background: "#6c63ff" }} onClick={createAccount}>Account Erstellen</a>
                                        </div>
                                        <div className="uk-text-small uk-text-center">
                                            Bereits registriert? <a href="/login" style={{ color: "#6c63ff" }}>Login</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
